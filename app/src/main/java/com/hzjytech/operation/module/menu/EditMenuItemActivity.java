...
public class EditMenuItemActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        mTvOriginPrice.setText(mData.getPrice() + "元");
        mTvVolume.setText(mData.getVolume() + "ml");
        mTvNowPrice.setText(mData.getDiscountPrice() + "元");
        mTvWeixinPrice.setText(mData.getWxpayPrice() + "元");
        mTvAliPrice.setText(mData.getAlipayPrice() + "元");
        ...
        if (mEditAuth) {
            ...
            mTvSaleStatu.setText(mData.isSaleStatus() ? "在售" : "告罄");
        ...
        if (resultCode == Activity.RESULT_OK && data != null) {
            switch (requestCode) {
                case CropImage.PICK_IMAGE_CHOOSER_REQUEST_CODE:
                    ...
                    if (mImageUri != null) {
                        String url = StringUtil.getRealFilePath(this, mImageUri);
                        mData.setUrl(url);
                        mPicChanged = true;
                    }
                    break;
    ...
    private void commitResult() {
        ...
        itemInfo.addProperty("discountPrice", mData.getDiscountPrice());
        itemInfo.addProperty("isHot", mData.isIsHot());
        itemInfo.addProperty("isSweet", mData.isIsSweet());
        itemInfo.addProperty("isIced", mData.isIsIced());
        itemInfo.addProperty("isNew", mData.isIsNew());
        itemInfo.addProperty("wxpayPrice", mData.getWxpayPrice());
        itemInfo.addProperty("alipayPrice", mData.getAlipayPrice());
        itemInfo.addProperty("nameCh", mData.getNameCh());
        itemInfo.addProperty("nameEn", mData.getNameEn());
        itemInfo.addProperty("price", mData.getPrice());
        itemInfo.addProperty("volume", mData.getVolume());
        itemInfo.addProperty("recipeId", mData.getRecipeId());
        itemInfo.addProperty("sequence", mData.getSequence());
        itemInfo.addProperty("saleStatus", mData.isSaleStatus());
        String substring = mData.getUrl()
                .substring(mData.getUrl()
                                .lastIndexOf("/"),
                        mData.getUrl()
                                .length());
        itemInfo.addProperty("fileName", substring);
        Observable<Object> observable = MenuApi.changeMenuItem(UserUtils.getUserInfo()
                .getToken(), mData.getId(), itemInfo.toString());
        JijiaHttpSubscriber subscriber = JijiaHttpSubscriber.buildSubscriber(this)
                .setOnNextListener(new SubscriberOnNextListener() {
                    @Override
                    public void onNext(Object o) {
