...
public class MenuItemViewHolder extends RecyclerView.ViewHolder {
    ...
    @BindView(R.id.tv_check_more_menu)
    TextView mTvCheckMoreMenu;
    @BindView(R.id.tv_add_menu)
    TextView mTvAddMenu;
    @BindView(R.id.ll_more_menus)
    LinearLayout mLlMoreMenus;
    ...
    public void setMenuItemData(
        ...
        View foot = mLlMenuItemContainer.getChildAt(mLlMenuItemContainer.getChildCount() - 1);
        ...
        if (itemsBeens == null || itemsBeens.size() == 0) {
            if(!AUTH_DELET_ADD_MENU_ITEM){
                ...
                mLlMenuItemContainer.setLayoutParams(layoutParams);
                mLlMenuItemContainer.setVisibility(View.GONE);
            }else {
